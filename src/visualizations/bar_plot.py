...
def main(path_1, path_2, num_demos):
    ...
    fig, ax = plt.subplots()
    rects1 = ax.bar(x - width / 2, values_1, width, label="Method 1")
    rects2 = ax.bar(x + width / 2, values_2, width, label="Method 2")
...
if __name__ == "__main__":
    path_1 = "logs/test_eefinpaintcem/plot/stats.pkl"
    path_2 = "logs/test_eefinpaintcem/plot/stats.pkl"
    num_demos = 100
    main(path_1, path_2, num_demos)