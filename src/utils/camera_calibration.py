...
world_to_camera_dict = {
    ...
    "sawyer_vestri_table2_0": np.array(
        [
    ...
    "sawyer_vestri_table2_1": np.array(
        [
    ...
    "sawyer_vestri_table2_2": np.array(
        [
